...
public class NormalRandom implements ContinuousGenerator {
   ...
   */
  public NormalRandom(String name, double mean, double variance) {
    if (variance <= 0.0) {
      throw new Error("Sim_normal_obj: The variance must be greater than 0.");
    }
   ...
   */
  public NormalRandom(String name, double mean, double variance, long seed) {
    if (variance <= 0.0) {
      throw new Error("Sim_normal_obj: The variance must be greater than 0.");
    }
  ...
  static double sample(RandomP source, double mean, double variance) {
    double result;
